...
export default function PixelCard({
  ...
  // Initialize browser-specific values safely
  useEffect(() => {
  ...
  // Rest of your functions (doAnimate, handleAnimation, etc.)
  ...
  return (
    <div
      ref={containerRef}
      className={`h-[50px] w-[300px] relative overflow-hidden grid place-items-center aspect-[4/5] rounded-[25px] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
